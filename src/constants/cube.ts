...
// Verified against cubejs: every face's own 0-8 facelet numbering already
// matches a direct, unflipped row-major render in this projection, so no
// per-face mirroring is needed (unlike lastLayerView.ts's flap arrays,
// which reverse B for that view's different geometry).
